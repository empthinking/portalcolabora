...
<div class="max-w-md mx-auto bg-white shadow-md rounded-md p-6">
  <div class="flex">
    ...
    <div class="w-1/2">
      <h2 class="text-3xl font-bold mb-2"><?php echo $nome; ?></h2>
      <p class="text-gray-600 mb-4" style="font-size: 18px;"><?php echo $descricao; ?></p>
      <p class="text-xl font-bold">Preço: R$ <?php echo $preco; ?></p>
