...
<?php if(!$error): ?>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <a class="btn btn-success my-2" href="<?php echo isUserLoggedIn() ? htmlspecialchars($_SERVER['PHP_SELF']) . "?id=$product_id&mode=register" : "login.php"; ?>"><i class="fas fa-envelope"></i> Contatar</a>
