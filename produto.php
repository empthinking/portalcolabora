...
<?php if(!$error): ?>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <a class="btn btn-success" href="<?php echo isUserLoggedIn() ? htmlspecialchars($_SERVER['PHP_SELF']) . "?id=$product_id&mode=register" : "login.php"; ?>">Contatar<a>
                <a class="btn btn-success mt-2" <?php echo isUserLoggedIn() ? "href='https://api.whatsapp.com/send?phone=+55$User_Number&text=Olá, tudo bem?' target='_blank'" : "href=login.php"; ?> >Enviar mensagem pelo WhatsApp </a>
            </div>
        </div>
