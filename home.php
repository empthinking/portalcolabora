...
<main>
  ...
  <button id="botaoFiltro" class="bg-green-500 text-white font-bold py-2
            px-4 rounded-full md:fixed top-auto left-10 ">
    Abrir Menu
  </button>
    ...
    <div class="menu-container fixed inset-0 overflow-hidden z-50">
      ...
      <div class="menu-content fixed inset-y-0 right-0 flex flex-col
        ...
        <div class="px-4 py-3 border-b">
          ...
          <button id="filtroBack" class="bg-green-300 text-white
                    font-bold py-2 px-4 rounded-full fixed mt-80 ">
            Feichar Menu
          </button>
        </div>
        <div class="px-4 py-3 border-b">
          ...
          <div class="relative">
            ...
            <div class="pointer-events-none absolute inset-y-0 right-0
              ...
              <svg class="fill-current h-4 w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
                <path d="M14.95 7.95a1 1 0 01-1.41 0L10 4.91 6.46 8.46a1 1 0
                          01-1.41-1.41l4-4a1 1 0 011.41 0l4 4a1 1 0 010 1.41z" />
              </svg>
            </div>
          </div>
          <br>
          ...
          <div class="flex flex-wrap">
            <button class="bg-blue-500 text-white py-2 px-4 rounded-full active:bg-red-500 active:text-yellow-500
                        mr-2 mb-2">Até R$ 50</button>
        ...
        <div class="container sm:m-4">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3
            ...
            <div class="bg-white rounded-lg overflow-hidden
                        shadow-md">
              <div class="relative">
                <img src="<%= posts[0].imagem %>" alt="Produto 1" class="w-full h-64 object-cover">
              </div>
              <div class="p-6">
                <h3 class="text-lg font-semibold mb-2">
                  <%= posts[0].titulo %>
                </h3>
                <p class="text-gray-700 font-medium mb-2">R$ <%= posts[0].preco %>
                </p>
                <p class="text-gray-700 mb-4"> <%- posts[0].conteudo %> </p>
              </div>
            </div>
      </a>
      <a href="<%= posts[1].slug %>">
        <div class="bg-white rounded-lg overflow-hidden
                              shadow-md">
          <div class="relative">
            <img src="<%= posts[1].imagem %>" alt="Produto
          ...
          <div class="p-6">
            ...
            <p class="text-gray-700 font-medium mb-2">R$
              <%= posts[1].preco %>
            </p>
            <p class="text-gray-700 mb-4"> <%- posts[1].conteudo %>
          </div>
        </div>
      </a>
