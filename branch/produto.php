...
<?php if(!$error): ?>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <a class="btn btn-success" href="<?php echo echo isUserLoggedIn() ? : htmlspecialchars($_SERVER['PHP_SELF']) . "?id=$product_id&mode=register" : "login.php"; ?>">Contatar<a>
                <a class="btn btn-success" href="<?php echo isUserLoggedIn() ? "https://api.whatsapp.com/send?phone=+55$User_Number&text=Olá, tudo bem?" : "login.php"; ?>target="_blank">Enviar mensagem pelo WhatsApp </a>
            </div>
        </div>
