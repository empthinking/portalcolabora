...
<?php if(!$error): ?>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <a class="btn btn-success" <?php echo isUserLoggedIn() ? "href='https://api.whatsapp.com/send?phone=+55$User_Number&text=Olá, tudo bem?' target='_blank'" : "login.php"; ?> >Enviar mensagem pelo WhatsApp </a>
            </div>
        </div>
