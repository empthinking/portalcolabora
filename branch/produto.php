...
<?php if(!$error): ?>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <a class="btn btn-success" href="https://api.whatsapp.com/send?phone=+55<?php echo $User_Number; ?>&text=Olá, tudo bem?" target="_blank">Enviar mensagem pelo WhatsApp </a>
            </div>
        </div>
