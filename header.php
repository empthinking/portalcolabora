    ...
    <nav class="navbar py-2">
        <div class="mx-auto px-4 sm:px-6 lg:px-8 md:flex  md:items-center justify-between">
            ...
            <div class="flex items-center py-2 -mx-4 md:mx-4 ">
                <form method="post" action="pesquisa.php">
                    <div class="relative mr-10 md:mx-0">
                        <input
                            class="bg-gray-200 rounded-full border-transparent focus:border-gray-500 focus:bg-white focus:ring-0 pl-4 pr-10 py-2 w-100"
            ...
            <div class="flex items-center ml-5">
                <a href="cadastro.php"><button
                        class="bg-green-400 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-full ml-4">Cadastrar</button></a>
                            ...
                            <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <a class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800"
                                        href="/B/adm/login_admin.php">entrar como admin </a>
                                </div>
                            </form>
