            ...
            <div class="menu-items hidden md:block">
                <div class="menu-toggle">
                    ...
                    <div class="flex items-center ml-5">
                        <a href="cadastro.php">
                            <button
                                class="bg-green-400 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-full ml-4 w-auto sm:w-auto md:w-auto lg:w-auto">Cadastrar</button>
                        </a>
                        <button
                            class="bg-green-200 hover:bg-green-600 text-white font-bold py-2 px-4 rounded-full ml-2 w-auto sm:w-auto md:w-auto lg:w-auto"
                            onclick="document.getElementById('signIn').style.display='block'">Entrar</button>
                    </div>
