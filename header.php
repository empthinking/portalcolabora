        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userMenuDropdown">
                    ...
                    <a class="dropdown-item" href="meusprodutos.php"><i class="fab fa-product-hunt"></i> Meus Produtos</a>
                    <a class="dropdown-item <?php echo $checkUnreadMessages() ? 'text-danger font-weight-bold' : ''; ?>" href="mensagens.php"><i class="fas fa-comments"></i> Mensagens</a>
                    <?php endif; ?>
               <!--     <a class="dropdown-item" href="#">Configuração</a> -->
                    <a class="dropdown-item" href="logout.php"><i class="fas fa-chevron-right"></i> Sair</a>
                </div>
            </li>
        </ul>
    <?php else: ?>
