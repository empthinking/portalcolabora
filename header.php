		...
		<div class="mx-auto px-4 sm:px-6 lg:px-8 md:flex  md:items-center justify-between w-full">
			...
			<div class="flex items-center w-3/5">
				...
				<div class="flex items-center ml-5  w-1/5">
					...
					<!-- Botão de login -->
					<button class="bg-green-200 hover:bg-green-600 text-white font-bold py-2 px-4 rounded-full ml-2" onclick="document.getElementById('singIn').style.display='visible'">
						Entrar
					</button>
					<div id="singIn" class="hidden">
