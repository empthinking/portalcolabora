...
if ($deleteStmt->execute()) {
    if (unlink($image_path)) {
        $_SESSION['message'] = "Imagem excluída com sucesso!";
    } else {
        $_SESSION['message'] = "Falha ao excluir a imagem do diretório.";
    }
} else {
    $_SESSION['message'] = "Falha ao excluir a imagem do banco de dados.";
}
