...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (!empty($senha)) {
        // Criptografar a senha usando a função password_hash
        $senha_hash = password_hash($senha, PASSWORD_DEFAULT);

        // Atualizar os dados do usuário no banco de dados, incluindo a senha criptografada
        $sql = "UPDATE usuarios SET user_nome = '$nome', user_email = '$email', user_senha = '$senha_hash' WHERE user_id = '$usuario_id'";
    } else {
        // Caso a senha não tenha sido fornecida, atualizar apenas nome e email
        $sql = "UPDATE usuarios SET user_nome = '$nome', user_email = '$email' WHERE user_id = '$usuario_id'";
    }
