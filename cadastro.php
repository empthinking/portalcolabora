...
<body>
                ...
                <div class="max-w-lg mx-auto">
                  ...
                  echo '<div class="erro">' . $erro_email . '</div>';
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                <input
                                    class="user_senha-input appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"
                                ...
                                <span class="absolute top-0 right-0 mr-4 mt-5">
                                    <button type="button" id="showPassword"
                                        class="text-gray-500 font-semibold focus:outline-none">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative">
                                <input
                                    class="user_senha-input appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"
                                    id="confirma-senha" name="confirm_password" type="password" value=""
                        ...
                        <div class="mb-4">
                            <label class="block text-gray-700 font-bold mb-2" for="radio-comprador">
                                Comprador
                                <input class="mr-2" type="radio" id="radio-comprador" name="permissao_publicar"
                                    value="0" checked>
                            </label>
                            <label class="block text-gray-700 font-bold mb-2" for="radio-produtor">
                                Produtor
                                <input class="mr-2" type="radio" id="radio-produtor" name="permissao_publicar"
                                    value="1">
                            </label>
    ...
    <!-- Substitua xxxxxxxxxx pelo seu kit ID do FontAwesome -->
    <script>
