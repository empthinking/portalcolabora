...
<div class="flex items-center justify-centermt-  menu-overlay" >
        ...
        <div class="mt-6">
          ...
          <h3 class="text-3xl font-bold text-gray-500"><?php echo isset($_SESSION['login']) ? $_SESSION['email'] : '.'; ?></h3>
          <div id="btp" class="mt-4">
            <h3 class="text-2xl font-bold">Número</h3>
            <h3 class="text-3xl font-bold text-gray-500"><?php echo isset($_SESSION['login']) ? $_SESSION['number'] : '.'; ?></h3>
                     </div>
                     <br>
